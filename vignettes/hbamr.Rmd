...
|                               | HBAM<br>  | HBAM<br>NE | HBAM<br>HM | HBAM<br>MINI | HBAM<br>MULTI | HBAM<br>0 | HBAM<br>MULTI_0 |
|----------------------------|:-------:|:-------:|:-------:|:-------:|:-------:|:-------:|:-------:|
| Hierarchical priors           |     X     |     X      |     X      |      X       |       X       |     X     |        X        |
| Scale flipping                |     X     |     X      |     X      |      X       |       X       |           |                 |
| Group-differences             |           |            |            |              |       X       |           |        X        |
| Respondent pos. as parameters |     X     |            |     X      |              |               |     X     |                 |
| Heteroskedastic errors        |     X     |     X      |            |              |               |     X     |        X        |
| Faster/safer sampling         |           |            |            |      X       |               |     X     |        X        |

: Summary of model characteristics, part I

|                                      | FBAM<br>MINI | FBAM<br>MULTI | FBAM<br>MULTI_0 | HBAM<br>R | HBAM<br>R_MINI | BAM<br>  |
|------------------------------|:--------:|:--------:|:--------:|:--------:|:--------:|:--------:|
