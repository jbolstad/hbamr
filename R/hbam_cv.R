...
#' @param prep_data Logical: Should the data be prepared before fitting the model? If the data have already been prepared in advance by first running `prep_data()` and `prep_data_cv()`, set `prep_data = FALSE`. Defaults to `prep_data = TRUE`.
